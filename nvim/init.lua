...
vim.opt.rtp:append("~/.cache/dein/repos/github.com/Shougo/ddc-around.vim")
vim.opt.rtp:append("~/.cache/dein/repos/github.com/Shougo/ddc-sorter_rank.vim")
vim.opt.rtp:append("~/.cache/dein/repos/github.com/Shougo/ddc-matcher_head.vim")
