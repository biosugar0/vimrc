...
local function get_syn_info()
  ...
  print("name: " .. baseSyn.name ..  " ctermfg: " .. baseSyn.ctermfg ..  " ctermbg: " .. baseSyn.ctermbg ..  " guifg: " .. baseSyn.guifg .. " guibg: " .. baseSyn.guibg)
  local linkedSyn = get_syn_attr(get_syn_id(1))
  print("link to")
  print("name: " .. linkedSyn.name .. " ctermfg: " .. linkedSyn.ctermfg .. " ctermbg: " .. linkedSyn.ctermbg .. " guifg: " .. linkedSyn.guifg .. " guibg: " .. linkedSyn.guibg)
end
