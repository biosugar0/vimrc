...
command! PackInstall call s:init() | call PackInit() | call minpac#update('') | call minpac#status() | 1sleep | qa
command! PackUpdate  call s:init() | call PackInit() | call minpac#update('', {'do': 'call minpac#status()'})
command! PackClean   call s:init() | call PackInit() | call minpac#clean()
command! PackStatus  call s:init() | call PackInit() | call minpac#status()
